...
const Contact = () => {
  ...
  return (
    <section id="contact" className="w-full px-16 py-20 dark:bg-black bg-[#FFFFFF]">
      <div className="flex justify-center text-center items-center">
        <Title title={"Contact"} des={"Contact With Me"} />
      </div>
      <div className="w-full">
        <div className="w-full flex flex-col lgl:flex-row lgl:mt-5 justify-center items-center gap-10">
          <div className="w-1/2 lgl:w-[35%] h-full py-10 dark:bg-[#001919] bg-[#F5FCFF] flex flex-col gap-8 p-4 lgl:p-8 rounded-lg shadow-md">
